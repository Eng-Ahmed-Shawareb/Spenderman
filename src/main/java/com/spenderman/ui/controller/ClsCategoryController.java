...
/**
 * Class representing ClsCategoryController.
 *
...
public class ClsCategoryController extends ABaseController implements IObserver {
    ...
    @FXML
    private GridPane _categoryGrid;
    ...
    /**
     * Method to _handleDeleteCategory.
     *
     * @param c the c
     */
    ...
    public void update(EnEvenType evenType, Object data) {
        if (evenType == EnEvenType.CATEGORY_ADDED || evenType == EnEvenType.CATEGORY_DELETED || evenType == EnEvenType.TRANSACTION_ADDED || evenType == EnEvenType.TRANSACTION_UPDATED || evenType == EnEvenType.TRANSACTION_DELETED) {
            refreshData();
        }
    }
}
